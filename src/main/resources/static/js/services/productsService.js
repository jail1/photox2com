(function () {
    ...
    function ProductsService($http, $q, APP_URL) {
        ...
        function updateProductName(productId, newName){
            var d = $q.defer();
            $http.post(APP_URL + '/updateProductName/' + productId , newName).success(function (response) {
                d.resolve(response);
            }).error(function (rejection) {
                d.resolve(rejection);
            });
        ...
        function updateProductExtra(productId, extra){
            var d = $q.defer();
            $http.post(APP_URL + '/updateProductExtra/' + productId , extra).success(function (response) {
                d.resolve(response);
            }).error(function (rejection) {
                d.resolve(rejection);
            });
        ...
        function getAllListedProducts() {
            var d = $q.defer();
            $http.get(APP_URL + '/getAllListedProducts').success(function (response) {
                d.resolve(response);
            });
            return d.promise;
        }

        function getAlbumProducts() {
            var d = $q.defer();
            $http.get(APP_URL + '/getAlbumProducts').success(function (response) {
                d.resolve(response);
            });
            return d.promise;
        }

        function getPictureProducts() {
            var d = $q.defer();
            $http.get(APP_URL + '/getPictureProducts').success(function (response) {
                d.resolve(response);
            });
            return d.promise;
        }
        ...
        var service = {
            ...
            updateProductExtra : updateProductExtra,
            getAllListedProducts : getAllListedProducts,
            getAlbumProducts : getAlbumProducts,
            getPictureProducts : getPictureProducts
        }
        return service;
    }
}).call(this);