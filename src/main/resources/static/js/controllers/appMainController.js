(function () {
    ...
    angular.module('photoX').controller('MainController', MainController);

    MainController.$inject = ['$controller', '$scope', '$rootScope', '$state', '$timeout', '$log', 'moment', '$mdDialog', '$mdSidenav', '$mdBottomSheet', '_'];

    function MainController($controller , $scope, $rootScope, $state, $timeout, $log, moment, $mdDialog, $mdSidenav, $mdBottomSheet, _) {
