...
import ro.activemall.photoxserver.json.ExtraDataJSON;
...
public class ProductsController {
	...
	public List<ProductJSON> getAllListedProducts() {
		return service.getAllListedProducts();
	}
	@Secured({ RolesAsStrings.ROLE_SUPER_ADMIN , RolesAsStrings.ROLE_PHOTOGRAPHER , RolesAsStrings.ROLE_PHOTOGRAPHERS_CLIENT })
	@RequestMapping(value = ApiUrls.GETALBUMPRODUCTS, method = RequestMethod.GET, produces = ApiUrls.JSON)
	public List<ProductJSON> getAlbumProducts() {
		return service.getAlbumProducts();
	}
	@Secured({ RolesAsStrings.ROLE_SUPER_ADMIN , RolesAsStrings.ROLE_PHOTOGRAPHER , RolesAsStrings.ROLE_PHOTOGRAPHERS_CLIENT })
	@RequestMapping(value = ApiUrls.GETPICTUREPRODUCTS, method = RequestMethod.GET, produces = ApiUrls.JSON)
	public List<ProductJSON> getPictureProducts() {
		return service.getPictureProducts();
	}	
	...
	@Secured({ RolesAsStrings.ROLE_SUPER_ADMIN })
	@RequestMapping(value = ApiUrls.UPDATEPRODUCTNAME, method = RequestMethod.POST, produces = ApiUrls.JSON)
	public Product updateProductName(@PathVariable Long productId, @RequestBody String productName) {
		return service.updateProductName(productId, productName);
	}
	
	@Secured({ RolesAsStrings.ROLE_SUPER_ADMIN })
	@RequestMapping(value = ApiUrls.UPDATEPRODUCTEXTRA, method = RequestMethod.POST, produces = ApiUrls.JSON)
	public Product updateProductExtra(@PathVariable Long productId, @RequestBody ExtraDataJSON productExtra) {
		return service.updateProductExtra(productId, productExtra);
	}
