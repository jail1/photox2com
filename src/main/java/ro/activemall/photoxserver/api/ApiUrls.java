...
public class ApiUrls {
	...
	public static final String TESTRESOURCEUPLOAD =		PRIVAPI_V1+"testResourceUpload";
	...
	public static final String UPDATEPRODUCTNAME = 		PRIVAPI_V1+"updateProductName/{productId}";
	public static final String UPDATEPRODUCTEXTRA = 	PRIVAPI_V1+"updateProductExtra/{productId}";
	
	public static final String GETPRODUCTS = 			PRIVAPI_V1+"getAllListedProducts";
	public static final String GETALBUMPRODUCTS =		PRIVAPI_V1+"getAlbumProducts";
	public static final String GETPICTUREPRODUCTS =		PRIVAPI_V1+"getPictureProducts";
